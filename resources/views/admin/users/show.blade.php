...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex gap-2">
        <a href="{{ route('admin.users.edit', $user) }}" class="bg-green-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-green-700">
            <span class="material-symbols-outlined text-sm">edit</span>
            Edit User
        </a>
        <a href="{{ route('admin.users.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-gray-700">
