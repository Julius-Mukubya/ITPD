...
<div class="mb-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Edit Campaign</h2>
            <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Update campaign details and settings</p>
        </div>
