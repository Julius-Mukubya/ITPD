...
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Quiz</h2>
            <p class="text-gray-600 dark:text-gray-400">Update quiz information and questions</p>
        </div>
        <a href="{{ route('admin.quizzes.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors">
            Back to Quizzes
        </a>
    </div>
</div>
