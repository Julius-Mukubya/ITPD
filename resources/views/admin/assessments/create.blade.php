...
<div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
    ...
    <form action="{{ route('admin.assessments.store') }}" method="POST" id="assessmentForm" enctype="multipart/form-data">
        @csrf
                ...
                <div class="space-y-3">
                    ...
                    <div id="image_preview" class="hidden">
                        <div class="relative inline-block">
                            ...
                            <div class="absolute top-2 left-2 bg-green-500 text-white text-xs px-2 py-1 rounded">Preview</div>
