    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg flex flex-col h-[700px]">
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 rounded-b-2xl">
                    <form action="{{ route('public.counseling.session.message', $session) }}" method="POST" enctype="multipart/form-data" class="space-y-3" id="messageForm">
                        ...
                        <!-- File Preview -->
                        <div id="filePreview" class="hidden bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                            <div class="flex items-center justify-between">
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="flex flex-col gap-2">
                                <button type="submit" class="bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-3 rounded-xl hover:shadow-lg hover:shadow-emerald-500/30 transition-all" title="Send message">
                                    <span class="material-symbols-outlined">send</span>
                                </button>
                                <label class="bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400 p-3 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 transition-all cursor-pointer" title="Attach file" id="attachLabel">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg p-6">
                ...
                <div class="mb-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-3">
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button onclick="document.getElementById('followUpModal').classList.remove('hidden')" 
                        class="w-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 px-4 py-2 rounded-lg hover:bg-emerald-200 dark:hover:bg-emerald-900/50 transition-all text-sm font-medium flex items-center justify-center gap-2">
...
<div id="followUpModal" class="hidden fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full shadow-2xl">
        ...
        <form action="{{ route('public.counseling.session.followup', $session) }}" method="POST">
            ...
            <div class="space-y-4 mb-6">
                <div>
                    ...
                    <textarea name="reason" rows="3" 
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white resize-none text-sm"
                ...
                <div>
                    ...
                    <input type="datetime-local" name="preferred_datetime" 
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white text-sm">
                </div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="flex-1 bg-emerald-600 text-white px-4 py-3 rounded-xl font-semibold hover:bg-emerald-700 transition-all">
                    Schedule Follow-up
                </button>
...
function handleFileSelect(input) {
    ...
    if (file) {
        ...
        attachLabel.classList.remove('bg-gray-200', 'dark:bg-gray-700');
...
function clearAttachment() {
    ...
    attachLabel.classList.add('bg-gray-200', 'dark:bg-gray-700');
}
