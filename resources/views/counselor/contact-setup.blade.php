...
<div class="flex flex-col gap-4 mb-6">
    <div class="flex flex-col gap-1">
        <p class="text-gray-900 dark:text-white text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Contact Setup</p>
...
<div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm mb-6">
    ...
    <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div class="flex-1">
                ...
                <div class="relative">
                    ...
                    <input type="tel" id="phone" 
                           ...
                           class="w-full pl-10 pr-4 py-3 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary dark:bg-gray-700 dark:text-white">
                </div>
            </div>
            <div class="flex-shrink-0">
                <button onclick="saveField('phone')" class="w-full lg:w-auto bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 text-sm font-medium flex items-center justify-center gap-1">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end gap-3 lg:gap-4">
            ...
            <div class="flex-shrink-0">
                <button onclick="saveField('whatsapp_number')" class="w-full lg:w-auto bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 text-sm font-medium flex items-center justify-center gap-1">
                    <span class="material-symbols-outlined text-sm">save</span>
                    <span class="hidden sm:inline">Save</span>
                </button>
            </div>
        ...
        <div class="flex flex-col lg:flex-row lg:items-end gap-3 lg:gap-4">
            ...
            <div class="flex-shrink-0">
                <button onclick="saveField('counselor_email')" class="w-full lg:w-auto bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 text-sm font-medium flex items-center justify-center gap-1">
                    <span class="material-symbols-outlined text-sm">save</span>
                    <span class="hidden sm:inline">Save</span>
                </button>
            </div>
...
<div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm mb-6">
    ...
    <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end gap-3 lg:gap-4">
            ...
            <div class="flex-shrink-0">
                <button onclick="saveField('office_phone')" class="w-full lg:w-auto bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 text-sm font-medium flex items-center justify-center gap-1">
                    <span class="material-symbols-outlined text-sm">save</span>
                    <span class="hidden sm:inline">Save</span>
                </button>
            </div>
            ...
            <div class="flex-1">
                ...
                <div class="relative">
                    ...
                    <textarea id="office_address" rows="3"
                              ...
                              class="w-full pl-10 pr-4 py-3 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary dark:bg-gray-700 dark:text-white resize-none">{{ $user->office_address }}</textarea>
                </div>
            </div>
            <div class="flex-shrink-0 lg:pt-7">
                <button onclick="saveField('office_address')" class="w-full lg:w-auto bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 text-sm font-medium flex items-center justify-center gap-1">
                    <span class="material-symbols-outlined text-sm">save</span>
                    <span class="hidden sm:inline">Save</span>
                </button>
            </div>
...
<div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm mb-6">
    <div class="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button onclick="showAddCustomModal()" class="w-full sm:w-auto bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 text-sm font-medium flex items-center justify-center gap-1">
    ...
    <div class="p-4 sm:p-6">
        <div id="custom-contacts-list" class="space-y-3 sm:space-y-4">
            @if($user->custom_contact_info)
                @foreach($user->custom_contact_info as $key => $contact)
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg" data-key="{{ $key }}">
                    <div class="flex items-center gap-3 flex-1 min-w-0">
                        <span class="material-symbols-outlined text-purple-600 flex-shrink-0">{{ $contact['icon'] ?? 'contact_page' }}</span>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $contact['label'] }}</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400 break-all">{{ $contact['value'] }}</p>
                        </div>
                    </div>
                    <button onclick="deleteCustomContact('{{ $key }}')" class="text-red-600 hover:text-red-700 p-1 self-end sm:self-center">
                        <span class="material-symbols-outlined text-sm">delete</span>
                    </button>
                </div>
                @endforeach
            @else
                <div id="no-custom-contacts" class="text-center py-6 sm:py-8">
                    <span class="material-symbols-outlined text-3xl sm:text-4xl text-gray-300 dark:text-gray-600 mb-2">contact_page</span>
...
<div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm mb-6">
    <div class="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button onclick="showAddMeetingModal()" class="w-full sm:w-auto bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm font-medium flex items-center justify-center gap-1">
                <span class="material-symbols-outlined text-sm">add</span>
                <span class="hidden sm:inline">Add Meeting Link</span>
                <span class="sm:hidden">Add Link</span>
            </button>
        </div>
    </div>
    
    <div class="p-4 sm:p-6">
        <div id="meeting-links-list" class="space-y-3 sm:space-y-4">
            @if($user->default_meeting_links)
                @foreach($user->default_meeting_links as $key => $meeting)
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg" data-key="{{ $key }}">
                    <div class="flex items-center gap-3 flex-1 min-w-0">
                ...
                @endforeach
            @else
                <div id="no-meeting-links" class="text-center py-6 sm:py-8">
                    <span class="material-symbols-outlined text-3xl sm:text-4xl text-gray-300 dark:text-gray-600 mb-2">videocam</span>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm">
        ...
        <div class="p-4 sm:p-6">
            ...
            <div class="flex justify-center sm:justify-end mt-6">
                <button type="submit" class="w-full sm:w-auto bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-orange-700 transition-all flex items-center justify-center gap-2">
                    <span class="material-symbols-outlined">save</span>
                    <span class="hidden sm:inline">Save Availability Hours</span>
                    <span class="sm:hidden">Save Hours</span>
                </button>
            </div>
        </div>
    </div>
...
<div id="addCustomModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
        <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-4">Add Custom Contact</h3>
        ...
        <form id="addCustomForm" class="space-y-4">
            <div>
                ...
                <input type="text" id="custom_label" placeholder="e.g., Telegram, LinkedIn, Skype" required
                       class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div>
                ...
                <select id="custom_icon" class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary dark:bg-gray-700 dark:text-white">
            ...
            <div class="flex flex-col sm:flex-row gap-3 mt-6">
                <button type="submit" class="flex-1 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 font-medium text-sm sm:text-base">
                    Add Contact
                </button>
                <button type="button" onclick="hideAddCustomModal()" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 text-sm sm:text-base">
                    Cancel
                </button>
            </div>
        </form>
...
<div id="addMeetingModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
        <h3 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-4">Add Meeting Link</h3>
        ...
        <form id="addMeetingForm" class="space-y-4">
            <div>
                ...
                <select id="meeting_type" required class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary dark:bg-gray-700 dark:text-white">
            ...
            <div class="flex flex-col sm:flex-row gap-3 mt-6">
                <button type="submit" class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 font-medium text-sm sm:text-base">
                    Add Meeting Link
                </button>
                <button type="button" onclick="hideAddMeetingModal()" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 text-sm sm:text-base">
                    Cancel
                </button>
            </div>
        </form>
